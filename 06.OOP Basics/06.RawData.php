...
class Car{
    ...
    function __construct(string $model, Engine $engine, Cargo $cargo, Tyre $tyre1, Tyre $tyre2, Tyre $tyre3, Tyre $tyre4)
    {
        $this->model = $model;
        $this->engine = $engine;
        $this->cargo = $cargo;
        ...
        [$carInfo[0], intval($carInfo[1]), intval($carInfo[2]),
            intval($carInfo[3]),$carInfo[4], floatval($carInfo[5]),
             intval($carInfo[6]), floatval($carInfo[7]), intval($carInfo[8]),
                floatval($carInfo[9]), intval($carInfo[10]), floatval($carInfo[11]), intval($carInfo[12])];
